...
public class SourceConnectorIT extends DockerizedPlatformSetupApache implements TestConstants {
  ...
  // Connectordeployment creates a Kafka topic "kafkaTestTopic", which is used
  // next
  ...
  class SolaceConnectorSimpleMessageProcessorTests {
    ...
    void setUp() {
      ...
      prop.setProperty("sol.message_processor_class",
          "com.solace.source.connector.msgprocessors.SolSampleSimpleMessageProcessor");
  ...
  class SolaceConnectorNoneKeyedMessageProcessorTests {
    ...
    void setUp() {
      ...
      Properties prop = new Properties();
      prop.setProperty("sol.message_processor_class",
          "com.solace.source.connector.msgprocessors.SolaceSampleKeyedMessageProcessor");
