 ...
 * Refer to https://docs.solace.com/API-Developer-Online-Ref-Documentation/java/index.html for more
 * details under JCSMPProperties.
 */
public class SolaceSourceConstants {
	...
	public static final String SOL_PUB_USE_INTERMEDIATE_DIRECT_BUF = "sol.pub_use_immediate_direct_pub";
	public static final String SOL_MESSAGE_CALLBACK_ON_REACTOR = "sol.message_callback_on_reactor";
	public static final String SOL_IGNORE_DUPLICATE_SUBSCRIPTION_ERROR = "sol.ignore_duplicate_subscription_error";
	public static final String SOL_IGNORE_SUBSCRIPTION_NOT_FOUND_ERROR = "sol.ignore_subscription_not_found_error";
	...
	public static final String SOL_SSL_KEY_STORE_NORMALIZED_FORMAT = "sol.ssl_key_store_normalized_format";
	...
	public static final String SOL_CHANNEL_PROPERTY_connectTimeoutInMillis = "sol.channel_properties.connect_timout_in_millis";
	public static final String SOL_CHANNEL_PROPERTY_readTimeoutInMillis = "sol.channel_properties.read_timeout_in_millis";
	public static final String SOL_CHANNEL_PROPERTY_connectRetries = "sol.channel_properties.connect_retries";
	public static final String SOL_CHANNEL_PROPERTY_reconnectRetries = "sol.channel_properties.reconnect_retries";
	public static final String SOL_CHANNEL_PROPERTY_connectRetriesPerHost = "sol.channnel_properties.connect_retries_per_host";
	public static final String SOL_CHANNEL_PROPERTY_reconnectRetryWaitInMillis = "sol.channel_properties.reconnect_retry_wait_in_millis";
	public static final String SOL_CHANNEL_PROPERTY_keepAliveIntervalInMillis = "sol.channel_properties.keep_alive_interval_in_millis";
	public static final String SOL_CHANNEL_PROPERTY_keepAliveLimit = "sol.channel_properties.keep_alive_limit";
	public static final String SOL_CHANNEL_PROPERTY_sendBuffer = "sol.channel_properties.send_buffer";
	public static final String SOL_CHANNEL_PROPERTY_receiveBuffer = "sol.channle_properties.receive_buffer";
	public static final String SOL_CHANNEL_PROPERTY_tcpNoDelay = "sol.channel_properties.tcp_no_delay";
	public static final String SOL_CHANNEL_PROPERTY_compressionLevel = "sol.channel_properties.compression_level";
