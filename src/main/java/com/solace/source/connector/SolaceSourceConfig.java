...
public class SolaceSourceConfig extends AbstractConfig {
	...
	public static ConfigDef solaceConfigDef() {
		return new ConfigDef()
				...
				.define(SolaceSourceConstants.SOL_USERNAME, Type.STRING, "default", Importance.HIGH,
						"Solace username")
				.define(SolaceSourceConstants.SOL_PASSWORD, Type.STRING, "default", Importance.HIGH,
						"Solace user password")
				...
				.define(SolaceSourceConstants.SOl_QUEUE, Type.STRING, null, Importance.MEDIUM,
						"Solace queue to consume from")
				.define(SolaceSourceConstants.SOL_MESSAGE_PROCESSOR, Type.CLASS,
						SolMessageProcessor.class, Importance.HIGH,
						"default Solace message processor to use")
				.define(SolaceSourceConstants.SOL_LOCALHOST, Type.STRING,	null, Importance.LOW,
						"The hostname or IP address of the machine on which the application is running. On a multihomed machine, it is strongly recommended to provide this parameter to ensure JCSMP uses the correct network interface")	
				...
				.define(SolaceSourceConstants.SOL_GENERATE_SEND_TIMESTAMPS, Type.BOOLEAN, false, Importance.LOW,
						"indicates whether to generate a send timestamp in outgoing messages")
				.define(SolaceSourceConstants.SOL_GENERATE_RCV_TIMESTAMPS, Type.BOOLEAN, false, Importance.LOW,
						"Indicates whether to generate a receive timestamp on incoming messages")
				.define(SolaceSourceConstants.SOL_GENERATE_SEQUENCE_NUMBERS, Type.BOOLEAN, false, Importance.LOW,
						"Indicates whether to generate a sequence number in outgoing messages")
				.define(SolaceSourceConstants.SOL_CALCULATE_MESSAGE_EXPIRATION, Type.BOOLEAN, false, Importance.LOW,
						"Indicates whether to calculate message expiration time in outgoing messages and incoming messages")
				...
				.define(SolaceSourceConstants.SOL_PUB_USE_INTERMEDIATE_DIRECT_BUF, Type.BOOLEAN, true, Importance.LOW,
						"If enabled, during send operations, the XMLMessageProducer concatenates all published data. This can result in higher throughput for certain send operations. It can, however, lead to performance degradation for some scenarios with large messages")
				.define(SolaceSourceConstants.SOL_MESSAGE_CALLBACK_ON_REACTOR, Type.BOOLEAN, false, Importance.LOW,
				...
				.define(SolaceSourceConstants.SOL_IGNORE_DUPLICATE_SUBSCRIPTION_ERROR, Type.BOOLEAN, false, Importance.LOW,
						"ignore errors caused by subscriptions being already presents")
				.define(SolaceSourceConstants.SOL_IGNORE_SUBSCRIPTION_NOT_FOUND_ERROR, Type.BOOLEAN, false, Importance.LOW,
				...
				.define(SolaceSourceConstants.SOl_AUTHENTICATION_SCHEME, Type.STRING, "AUTHENTICATION_SCHEME_BASIC", Importance.MEDIUM,
						"String property specifying the authentication scheme.")
				.define(SolaceSourceConstants.SOL_KRB_SERVICE_NAME, Type.STRING, "solace", Importance.MEDIUM,
				...
				.define(SolaceSourceConstants.SOL_SSL_CONNECTION_DOWNGRADE_TO, Type.STRING, "", Importance.MEDIUM,
						"Session property specifying a transport protocol that SSL session connection will be downgraded to after client authentication. Allowed values: TRANSPORT_PROTOCOL_PLAIN_TEXT.")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_connectTimeoutInMillis, Type.INT, 30000, Importance.MEDIUM,
						"Timeout value (in ms) for creating an initial connection to Solace")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_readTimeoutInMillis, Type.INT, 10000, Importance.MEDIUM,
						"Timeout value (in ms) for reading a reply from Solace")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_connectRetries , Type.INT, 0, Importance.MEDIUM,
				...
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_reconnectRetries , Type.INT, 0, Importance.MEDIUM,
				...
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_connectRetriesPerHost, Type.INT, 0, Importance.MEDIUM,
						"This property defines how many times to try to connect or reconnect to a single host before moving to the next host in the list")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_reconnectRetryWaitInMillis, Type.INT, 3000, Importance.MEDIUM,
						"How much time in (MS) to wait between each attempt to connect or reconnect to a host")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_keepAliveIntervalInMillis, Type.INT, 3000, Importance.MEDIUM,
						"The amount of time (in ms) to wait between sending out keep-alive messages")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_keepAliveLimit, Type.INT, 10, Importance.MEDIUM,
				...
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_sendBuffer, Type.INT, 65536, Importance.MEDIUM,
						"The size (in bytes) of the send socket buffer.")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_receiveBuffer, Type.INT, 65536, Importance.MEDIUM,
						"The size (in bytes) of the receive socket buffer.")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_tcpNoDelay, Type.BOOLEAN, true, Importance.LOW,
						"Whether to set the TCP_NODELAY option. When enabled, this option disables the Nagle's algorithm.")
				.define(SolaceSourceConstants.SOL_CHANNEL_PROPERTY_compressionLevel, Type.INT, 0, Importance.MEDIUM,
				...
				.define(SolaceSourceConstants.SOL_SUBSCRIBER_LOCAL_PRIORITY, Type.INT, 1, Importance.MEDIUM,
						"Subscriber priority is used to choose a client to receive messages sent with the DeliverToOne property set.")
				.define(SolaceSourceConstants.SOL_SUBSCRIBER_NETWORK_PRIORITY, Type.INT, 1, Importance.MEDIUM,
						"Subscriber priority is used to choose a client to receive messages sent with the DeliverToOne property set.")
				.define(SolaceSourceConstants.SOL_SUBSCRIBER_DTO_OVERRIDE, Type.BOOLEAN, true, Importance.LOW,
						"When adding topic subscriptions override DTO processing for any messages with DTO flags .")
				//.define(SolaceSourceConstants.SOL_SSL_PROTOCOL, Type.STRING, "SSLv3,TLSv1,TLSv1.1,TLSv1.2", Importance.LOW,
				//		"This property is used to specify a comma separated list of SSL protocols to use.")
				...
				.define(SolaceSourceConstants.SOL_SSL_CIPHER_SUITES, Type.STRING, "", Importance.LOW,
						"This property is used to specify a comma separated list of cipher suites in order of preference used for SSL connections. ")
				.define(SolaceSourceConstants.SOL_SSL_VALIDATE_CERTIFICATE, Type.BOOLEAN, true, Importance.LOW,
						"This property is used to specify whether the API should validate server certificates ")
				.define(SolaceSourceConstants.SOL_SSL_VALIDATE_CERTIFICATE_DATE, Type.BOOLEAN, true, Importance.LOW,
						"This property is used to specify whether the API should validate server certificate's expiry")
				.define(SolaceSourceConstants.SOL_SSL_TRUST_STORE, Type.STRING, "/lib/security/jssecacerts", Importance.LOW,
						"This property is used to specify the truststore file to use in URL or path format.")
				.define(SolaceSourceConstants.SOL_SSL_TRUST_STORE_PASSWORD, Type.STRING, "", Importance.LOW,
						"This property is used to specify the password of the truststore given in SSL_TRUST_STORE")
				.define(SolaceSourceConstants.SOL_SSL_TRUST_STORE_FORMAT, Type.STRING, "JKS", Importance.LOW,
						"This property is used to specify the format of the truststore given in SSL_TRUST_STORE.")
				.define(SolaceSourceConstants.SOL_SSL_TRUSTED_COMMON_NAME_LIST, Type.STRING, "", Importance.LOW,
				...
				.define(SolaceSourceConstants.SOL_SSL_KEY_STORE_PASSWORD, Type.STRING, "", Importance.LOW,
				...
				.define(SolaceSourceConstants.SOL_SSL_KEY_STORE_NORMALIZED_FORMAT, Type.STRING, "JKS", Importance.LOW,
