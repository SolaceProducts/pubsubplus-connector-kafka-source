...
* Search [GitHub](https://github.com/SolaceLabs/solace-kafka-connector-source/pulls) for an open or closed Pull Request
...
Fork the project [on GitHub](https://github.com/SolaceLabs/solace-kafka-connector-source) and clone your fork
locally.
...
```sh
$ git remote add upstream https://github.com/SolaceLabs/solace-kafka-connector-source
```
...
* Open a GitHub [enhancement request issue](https://github.com/SolaceLabs/solace-kafka-connector-source/issues/new) and describe the new functionality.
